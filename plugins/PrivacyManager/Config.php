...
use Piwik\Plugins\PrivacyManager\Settings\OrderIdAnonymisation as OrderIdAnonymisationSetting;
    ...
    private function getOptionValueWithPrivacyComplianceOverride(string $name, ?int $idSite, $optionValue)
    {
        ...
        if ($featureFlagManager->isFeatureActive(PrivacyCompliance::class)) {
            if ($name === 'ipAddressMaskLength') {
                ...
                return OrderIdAnonymisationSetting::getInstance($idSite)->getValue();
            }
        }
