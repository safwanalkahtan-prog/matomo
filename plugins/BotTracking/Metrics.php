...
class Metrics
{
    ...
    public static function getMetricTranslations(): array
    {
        return [
            ...
            self::COLUMN_REQUESTS                            => Piwik::translate('BotTracking_ColumnRequests'),
            self::COLUMN_ACQUIRED_VISITS                     => Piwik::translate('BotTracking_ColumnAcquiredVisits'),
        ];
    }
    ...
    public static function getMetricDocumentation(): array
    {
        return [
            ...
            self::COLUMN_REQUESTS                            => Piwik::translate('BotTracking_ColumnRequestsDocumentation'),
            self::COLUMN_ACQUIRED_VISITS                     => Piwik::translate('BotTracking_ColumnAcquiredVisitsDocumentation'),
        ];
    }
    ...
    public static function getMetricSemanticTypes(): array
    {
        return [
            ...
            self::COLUMN_REQUESTS                            => Dimension::TYPE_NUMBER,
            self::COLUMN_ACQUIRED_VISITS                     => Dimension::TYPE_NUMBER,
        ];
    }
